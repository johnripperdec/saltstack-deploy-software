include:
  ...
  - mysql.mysql-service
  - php.php-install-local
zabbix-server-dependence-rpm:
  file.managed:
    - name: /opt/iksemel-1.4-20.1.x86_64.rpm
    - source: salt://zabbix3-4/files/iksemel-1.4-20.1.x86_64.rpm
    - user: root
    - group: root
    - mode: 644
  cmd.run:
    - name: cd /opt && rpm -ivh iksemel-1.4-20.1.x86_64.rpm
    - require:
      - file: zabbix-server-dependence-rpm
